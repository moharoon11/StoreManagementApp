      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setModalState) {
          return AlertDialog(
            ...
            title: const Text('Adjust Product Stock', style: TextStyle(color: Color(0xFF0F172A), fontWeight: FontWeight.bold)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    style: const TextStyle(color: Color(0xFF0F172A)),
                    decoration: const InputDecoration(labelText: 'Quantity Change (+ add, - reduce)'),
                  ),
                  const SizedBox(height: 12),
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Expanded(
                child: Text('Stock Movements', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Color(0xFF0F172A), letterSpacing: -0.5), overflow: TextOverflow.ellipsis),
              ),
              ElevatedButton.icon(
          ...
          Expanded(
            child: _movements.isEmpty
                ? const Center(child: Text('No stock movement records found.', style: TextStyle(color: Color(0xFF64748B))))
                : ListView.builder(
                      ...
                      return Container(
                        ...
                        child: ListTile(
                          leading: CircleAvatar(
                            backgroundColor: isAddition ? const Color(0xFFECFDF5) : const Color(0xFFFEF2F2),
                            child: Icon(
                              isAddition ? Icons.add : Icons.remove,
                              color: isAddition ? const Color(0xFF10B981) : const Color(0xFFEF4444),
                              size: 20,
                            ),
                          ),
                          title: Text(m['productName'] ?? '', style: const TextStyle(color: Color(0xFF0F172A), fontWeight: FontWeight.bold, fontSize: 14)),
                          subtitle: Text('Prev: ${m['previousQuantity']} → New: ${m['newQuantity']}  (${m['reason']})', style: const TextStyle(color: Color(0xFF64748B), fontSize: 12)),
                          trailing: Text(
